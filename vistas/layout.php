...
<body>
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a class="nav-link" href="../controladores/rutasControlador.php?rutaOpc=3">CRUD</a>
              </li>                     
            </ul>
          </div>
        </div>
   ...
   <main class="col-12 bg-info p-4 d-flex flex-column align-items-center justify-content-start">
   ...
   <footer class="bg-secondary d-flex justify-content-lg-around align-items-center">
     <div class="d-flex justify-content-lg-around align-items-center m-2">
        <div class="m-3">
            <img class="ico" src="../assets/pic/github.png" alt="">
        </div>

        <div class="d-flex flex-column align-items-center">
            <p class="text-white m-0 p-0">Alexander Medina</p>
            <p class="text-white m-0 p-0">Usuario Github</p>
        </div>
